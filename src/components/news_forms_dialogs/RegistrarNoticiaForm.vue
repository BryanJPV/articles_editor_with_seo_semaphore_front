  ...
  <q-layout view="hHh lpR fFf" container >
        ...
        <div class="flex no-wrap items-center">
          ...
          <q-btn flat v-on:click="openDialogSeoGeneral" dense>
            <q-icon size="1.6rem" :color="semaforoSeoGeneral.estadisticas.color">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" role="img" aria-hidden="true" focusable="false"><defs></defs><path class="cls-1" d="M13.56 0H7a3.5 3.5 0 0 0-3.34 3.4v13.16A3.41 3.41 0 0 0 7.06 20h6.5A3.41 3.41 0 0 0 17 16.56V3.4A3.51 3.51 0 0 0 13.56 0zm1.9 16.08a2.37 2.37 0 0 1-2.35 2.37H7.52a2.37 2.37 0 0 1-2.35-2.37V3.86a2.37 2.37 0 0 1 2.35-2.37h5.59a2.37 2.37 0 0 1 2.35 2.37z"/><circle class="cls-1" cx="10.31" cy="9.98" r="2.15"/><circle class="cls-1" cx="10.31" cy="4.69" r="2.15"/><circle class="cls-1" cx="10.31" cy="15.31" r="2.15"/></svg>
            </q-icon>
          </q-btn>
          <q-btn flat v-on:click="openDialogSeoLegibilidad" dense>
            <q-icon size="1.6rem" :color="semaforoSeoLegibilidad.estadisticas.color" >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" role="img" aria-hidden="true" focusable="false"><path d="M2.42 19.81a.11.11 0 1 0 .19.1C5.75 14.5 8.88 17 13.17 14.17c-2.92 0-3.72-1.56-3.72-1.56a7 7 0 0 0 5.26.39c1-.8 2.79-2.64 2.93-6.59a3.44 3.44 0 0 1-2.42.29 4.81 4.81 0 0 0 2.4-1.7 5.85 5.85 0 0 0-2.74-5c.79 10.33-9.17 5.88-11.67 18.29A12.55 12.55 0 0 1 9 11.78c2.83-1.49 5.15-2.93 6-6.71-.64 4.56-2.7 6.25-5.55 7.53-2.66 1.2-5.39 2.68-7.03 7.21z"/></svg>
            </q-icon>
          </q-btn>
        </div>
    ...
    <q-footer>
      ...
      <q-toolbar class="bg-white text-black justify-end">
        ...
        <q-btn dense color="positive" v-on:click="registrarNewNoticia" label="Guardar" class="text-bold"></q-btn>
      </q-toolbar>
    </q-footer>
    ...
    <q-page-container>
      <q-page class="bg-white q-pa-sm row">
          <div class="col-xs-12 col-md-6 contenido-scroller">
            ...
            <div class="q-pa-xs">
              <q-input v-model="formNewNoticia.titulo" outlined label="Título" dense counter maxlength="150">
            ...
            <div class="q-pa-xs">
              <q-input v-model="formNewNoticia.subtitulo" outlined label="Subtítulo" dense counter maxlength="200">
                <template v-slot:prepend>
                  <q-icon name="text_fields"></q-icon>
                </template>
              </q-input>
            ...
            <div class="q-pa-xs">
              <q-input v-model="formNewNoticia.seo_url" outlined label="SEO URL" dense counter maxlength="200">
                <template v-slot:prepend>
            ...
            <div class="q-pa-xs">
              <q-input v-model="formNewNoticia.keywords" outlined label="Keywords" dense counter maxlength="200">
                <template v-slot:prepend>
                  <q-icon name="text_fields"></q-icon>
                </template>
              </q-input>
            ...
            <div class="q-pa-xs flex row justify-between">
              <div class="column" v-if="$q.screen.gt.xs">
                <div
                  ...
                  style="border-radius: .5rem; max-width: 200px; min-width: 200px; max-height: 200px; min-height: 200px; overflow: hidden; border: 1px solid #c2c2c2;"
                >
                  <q-icon
                    name="image"
                    color="grey-7"
                ...
                <q-img
                  ...
                  fit="contain"
                  class="q-mr-sm"
                  style="border-radius: .5rem; max-width: 200px; min-width: 200px; max-height: 200px; min-height: 200px; border: 1px solid #c2c2c2;"
                >
                  <div class="absolute-top-right flex column" style="padding: 3px; background-color: transparent;">
                    <q-btn @click="dialogCropImagenNoticia = true" size="12px" dense icon="crop" class="bg-white text-black"></q-btn>
                  </div>
                </q-img>
              </div>
                ...
                <div class="column col-12">
                  <div class="flex justify-center" v-if="!$q.screen.gt.xs">
                    <div
                      v-if="(formNewNoticia.img_url_blob === null || formNewNoticia.img_url === '')"
                      class="col flex justify-center items-center q-mr-sm q-mb-sm"
                      style="border-radius: .5rem; max-width: 275px; min-width: 275px; max-height: 275px; min-height: 275px; overflow: hidden; border: 1px solid #c2c2c2;"
                    >
                      <q-icon
                        name="image"
                        color="grey-7"
                    ...
                    <q-img
                      ...
                      fit="contain"
                      class="q-mb-sm"
                      style="border-radius: .5rem; max-width: 275px; min-width: 275px; max-height: 275px; min-height: 275px; border: 1px solid #c2c2c2;"
                    >
                      <div class="absolute-top-right flex column" style="padding: 3px; background-color: transparent;">
                          <q-btn @click="dialogCropImagenNoticia = true" size="12px" dense icon="crop" class="bg-white text-black"></q-btn>
                      </div>
                  ...
                  <div class="q-py-xs">
                    <q-input v-model="formNewNoticia.img_description" outlined label="Mención o fuente de la Portada" dense counter maxlength="150">
                      <template v-slot:prepend>
                  ...
                  >
                    <template v-slot:append>
                        ...
                        <q-icon name="timer" class="cursor-pointer">
                            <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                                <q-time v-model="formNewNoticia.publish_date" mask="YYYY-MM-DD HH:mm" format24h>
                                    <div class="row items-center justify-end">
                                        <q-btn v-close-popup label="OK" flat></q-btn>
                                    </div>
                                </q-time>
                  ...
                  <q-toggle v-model="formNewNoticia.status" color="positive" class="q-mt-sm"><b>Estado de Noticia</b></q-toggle>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row flex col-xs-12 col-md-6 items-start">
            <div class="col-12 contenido-scroller">
              <div class="column col-12">
                ...
                <div class="col-12 q-pa-xs flex column" v-for="(itemContenido, index) in formNewNoticia.news_content" :style="{ order : itemContenido.position }">
                  <div class="col-xs-12 q-pa-xs flex justify-between items-center">
                    ...
                    <div>
                      <q-btn size="sm" dense class="q-mr-xs" icon="move_up" @click="moverContenido(index, false)" :disable="itemContenido.position <= 1"></q-btn>
                      <q-btn size="sm" dense class="q-mr-xs" icon="move_down" @click="moverContenido(index, true)" :disable="itemContenido.position >= formNewNoticia.news_content.length"></q-btn>
                      <q-btn size="sm" dense class="q-mr-xs" icon="add" @click="agregarContenido(itemContenido.position)"></q-btn>
                      <q-btn size="sm" dense>
                        <q-icon name="delete" color="red" @click="eliminarContenido(index)"></q-icon>
                      </q-btn>
                    </div>
                  </div>
                  <div class="col-xs-12 q-pa-xs row justify-center items-center" style="border-radius: .5rem; border: 1px solid #c2c2c2;">
                    <q-select
                    ...
                    <div class="col-12">
                      <q-editor
                        ...
                        :toolbar="[
                          ...
                          },'unordered', 'ordered', 'outdent', 'indent','quote', 'link'],
                      ...
                      <div v-else-if="itemContenido.tipo >= 2 && itemContenido.tipo <= 4" class="row">
                        ...
                        >
                          <div
                            ...
                            style="border-radius: .3rem; min-height: 100%; overflow: hidden; border: 1px solid #c2c2c2;"
                          >
                            <q-icon
                              name="image"
                              color="grey-7"
                        ...
                        >
                          <q-img
                            ...
                            :ratio="1"
                            fit="contain"
                            style="border-radius: .3rem; min-height: 160px; max-height: 160px; overflow: hidden; border: 1px solid #c2c2c2;"
                          >
                            <div class="absolute-top-right flex column" style="padding: 3px; background-color: transparent;">
                                <q-btn @click="openDialogCroppedNewsContentImage(itemContenido)" size="12px" dense icon="crop" class="bg-white text-black"></q-btn>
                            </div>
                          </q-img>
                        </div>
                        <div :class="$q.screen.lt.sm ? 'col-12' : 'col'">
                          <q-file
                            ...
                            @update:model-value=" (files: any) => { convertImageToURLNoticiaContenido(files, itemContenido) } "
                            max-file-size="20971520"
                            @rejected="onRejected"
                          >
                            <template v-slot:prepend>
                      ...
                      <q-input v-else outlined dense v-model="itemContenido.contenido" type="textarea"></q-input>
                    </div>
                  </div>
                </div>

                <div class="q-pa-xs row col-xs-12" :style="{ order : formNewNoticia.news_content.length + 1 }">
                  <div class="col-xs-12 q-pa-xs flex justify-center items-center" style="border-radius: .5rem; border: 2px dashed #c2c2c2;">
                    <q-btn flat icon="add_circle" @click="agregarContenido(formNewNoticia.news_content.length + 1)" round color="grey-7"></q-btn>
                  </div>
                </div>
              </div>
            </div>
...
<script setup lang="ts">
  ...
  const cropImagenNoticiaTerminado = ( {urlFilePhotoCropped, croppedImageBlob}: any ) => {
    ...
    formNewNoticia.value.img_url_blob = new File([ croppedImageBlob ], nombreRespaldoImagenPortada.value, { type: tipoRespaldoImagenPortada.value });
  ...
  const registrarContenidoNoticia = async (idNoticia: number) => {
    ...
    try {
      ...
      $q.notify({
        type: 'negative',
        message: "No se pudo registrar correctamente los Componentes de la Noticia, intente más tarde.",
        position: 'top',
      });
    }
  }
  ...
  const cropImagenNoticiaContenidoTerminado = ( {urlFilePhotoCropped, croppedImageBlob}: any ) => {
    ...
    newsContentImagenNoticiaContenidoToCropAux.img_url_blob = new File([ croppedImageBlob ], nombreRespaldoImagenPortadaImagenNoticiaContenido.value, { type: tipoRespaldoImagenPortadaImagenNoticiaContenido.value });
  ...
  const moverContenido = (index: number, isDown: boolean) => {
    ...
    if (isDown) {
      let itemPosition = formNewNoticia.value.news_content.find((itemContenido) => itemContenido.position === position + 1);
...
<style scoped>
  ...
  .q-editor, .q-editor__toolbars-container {
